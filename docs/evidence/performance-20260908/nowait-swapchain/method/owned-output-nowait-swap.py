...
state=Path('/tmp/viewflow-owned-output-nowait-swap-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-nowait-swap-trials.py'],env=env,check=True)
finally:
