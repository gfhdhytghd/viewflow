...
state=Path('/tmp/viewflow-owned-output-alpha-diff-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-gpu-alpha-diff-trials.py'],env=env,check=True)
finally:
