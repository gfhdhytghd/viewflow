...
|---|---:|---:|---:|---:|---:|---:|---:|
| 4k-commit-grid-minimal-a1 | 58.007 | 42.903 | 19.348 | 19.958 | 67.220 | 83.400 | 133.923 |
| 4k-commit-event-minimal-b1 | 58.641 | 43.769 | 8.387 | 16.244 | 58.726 | 76.008 | 124.622 |
| 4k-commit-event-minimal-b2 | 58.882 | 44.780 | 7.762 | 16.282 | 58.556 | 71.196 | 157.291 |
| 4k-commit-grid-minimal-a2 | 58.221 | 42.132 | 6.554 | 7.040 | 54.569 | 70.386 | 272.596 |
...
|---|---:|---:|---:|---:|---:|
| 4k-commit-grid-minimal-a1 | 0.216 | 12.789 | 34.395 | 47.873 | 63.805 |
| 4k-commit-event-minimal-b1 | 0.233 | 13.092 | 36.590 | 51.228 | 64.000 |
| 4k-commit-event-minimal-b2 | 0.242 | 13.217 | 36.114 | 50.382 | 62.880 |
| 4k-commit-grid-minimal-a2 | 0.251 | 12.882 | 34.805 | 48.017 | 63.939 |
...
真实 A/B 的 60 fps streams 按日志顺序对应 A1/B1/B2/A2，attempts 为 1480/1481/1485/1482；B1/B2 分别记录主 surface notifications 1483/1488、commit attempts 1479/1484、fallback attempts 2/1。这些计数证明分支真实执行，不表示每次尝试都导出了帧。全部 start/stop 记录保留于 [嵌套 compositor 日志](nested/jeutsu3_/compositor.log.gz)。
