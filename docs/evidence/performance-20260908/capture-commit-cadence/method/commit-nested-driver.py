...
''')
 ...
 ctl('eval','hl.exec_cmd('+json.dumps(str(launcher))+', {no_initial_focus=true,monitor='+json.dumps(output)+',workspace='+json.dumps(str(ws)+' silent')+',float=true,size="3840 2400",move="0 0",no_anim=true,no_shadow=true,no_blur=true})')
 for _ in range(120):
