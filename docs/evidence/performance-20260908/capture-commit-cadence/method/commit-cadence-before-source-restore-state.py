...
Path('/tmp/viewflow-commit-cadence-final-state.json').write_text(json.dumps(v,indent=2)+'\n');print('original Windows binaries/PDB/configs and cleanup verified; Linux binary and prototype source unchanged through all trials',v['process_id'],v['priority'],len(v['threads']))
