...
state=Path('/tmp/viewflow-owned-output-nvenc-split-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-nvenc-split-trials.py'],env=env,check=True)
finally:
