...
state=Path('/tmp/viewflow-owned-output-codec-split-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-codec-split-trials.py'],env=env,check=True)
finally:
