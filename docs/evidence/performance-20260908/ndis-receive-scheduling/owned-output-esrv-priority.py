...
state=Path('/tmp/viewflow-owned-output-esrv-priority-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-esrv-priority-trials.py'],env=env,check=True)
finally:
