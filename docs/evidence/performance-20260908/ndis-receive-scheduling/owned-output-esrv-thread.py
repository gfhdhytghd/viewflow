...
state=Path('/tmp/viewflow-owned-output-esrv-thread-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-esrv-thread-trials.py'],env=env,check=True)
finally:
