...
state=Path('/tmp/viewflow-owned-output-esrv-observer-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-esrv-observer-trials.py'],env=env,check=True)
finally:
