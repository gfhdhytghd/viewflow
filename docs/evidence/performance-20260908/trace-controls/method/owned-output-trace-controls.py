...
state=Path('/tmp/viewflow-owned-output-trace-controls-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-trace-controls-trials.py'],env=env,check=True)
finally:
