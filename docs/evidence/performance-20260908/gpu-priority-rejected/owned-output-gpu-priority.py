...
state=Path('/tmp/viewflow-owned-output-gpu-priority-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-gpu-priority-trials.py'],env=env,check=True)
finally:
