...
int WINAPI wWinMain(HINSTANCE,HINSTANCE,PWSTR,int) {
  ...
  if(!argv || argc<4 || argc>6)return 2;
  ...
  try {init_apartment(apartment_type::multi_threaded);ObserverTimer timer(timer_requested,log);result=run(pid,duration,log,physical4k);}
