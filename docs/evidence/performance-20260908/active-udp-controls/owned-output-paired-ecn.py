...
state=Path('/tmp/viewflow-owned-output-paired-ecn-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-active-paired-ecn.py'],env=env,check=True)
finally:
