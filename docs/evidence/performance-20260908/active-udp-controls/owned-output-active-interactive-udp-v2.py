...
state=Path('/tmp/viewflow-owned-output-active-interactive-udp-v2-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-active-interactive-udp-v2.py'],env=env,check=True)
finally:
