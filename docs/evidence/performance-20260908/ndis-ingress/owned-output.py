...
state=Path('/tmp/viewflow-owned-output-ndis-network-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-ndis-network-trial.py'],env=env,check=True)
finally:
