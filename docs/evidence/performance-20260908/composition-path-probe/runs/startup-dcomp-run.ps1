...
$r='C:\Users\wilf\Viewflow\perf-isolated-8e97c1b751fc';$label='startup-dcomp';$mode='dcomp';$probe='ViewflowPerf-CompositionProbe';$observer='ViewflowPerf-CompositionProbeObserver';$exe=$r+'\viewflow_windows_composition_latency_probe.exe';$dd=$r+'\native-build\Release\viewflow_windows_frame_observer.exe';$pidSeen=0;$registeredProbe=$false;$registeredObserver=$false;$probeResult=-1;$observerResult=-1;
