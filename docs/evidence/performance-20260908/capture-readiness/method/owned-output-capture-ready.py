...
state=Path('/tmp/viewflow-owned-output-capture-ready-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-capture-ready-trials.py'],env=env,check=True)
finally:
