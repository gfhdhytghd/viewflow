...
state=Path('/tmp/viewflow-owned-output-deep-network-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-deep-network-trial.py'],env=env,check=True)
finally:
