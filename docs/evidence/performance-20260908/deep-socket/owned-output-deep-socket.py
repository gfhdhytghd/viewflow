...
state=Path('/tmp/viewflow-owned-output-deep-socket-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-deep-socket-trial.py'],env=env,check=True)
finally:
