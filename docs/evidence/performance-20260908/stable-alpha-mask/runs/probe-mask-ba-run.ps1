...
$r='C:\Users\wilf\Viewflow\perf-isolated-8e97c1b751fc';$label='probe-mask-ba';$mode='mask-toggle-reverse';$probe='ViewflowPerf-MaskUpdateProbe';$observer='ViewflowPerf-MaskUpdateProbeObserver';$exe=$r+'\viewflow_windows_mask_update_probe.exe';$dd=$r+'\native-build\Release\viewflow_windows_frame_observer.exe';$pidSeen=0;$registeredProbe=$false;$registeredObserver=$false;$probeResult=-1;$observerResult=-1;
