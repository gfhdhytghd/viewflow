...
state=Path('/tmp/viewflow-owned-output-alpha-share-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-native-alpha-share-trials.py'],env=env,check=True)
finally:
