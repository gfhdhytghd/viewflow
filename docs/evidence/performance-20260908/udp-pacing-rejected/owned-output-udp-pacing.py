...
state=Path('/tmp/viewflow-owned-output-udp-pacing-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-udp-pacing-trials.py'],env=env,check=True)
finally:
