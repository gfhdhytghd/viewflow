...
state=Path('/tmp/viewflow-owned-output-window-timer-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-window-timer-trials.py'],env=env,check=True)
finally:
