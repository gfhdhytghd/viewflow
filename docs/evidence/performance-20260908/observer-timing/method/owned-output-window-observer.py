...
state=Path('/tmp/viewflow-owned-output-window-observer-state.json');data={};output=None
...
try:
 ...
 subprocess.run(['python3','/tmp/viewflow-window-observer-trials.py'],env=env,check=True)
finally:
