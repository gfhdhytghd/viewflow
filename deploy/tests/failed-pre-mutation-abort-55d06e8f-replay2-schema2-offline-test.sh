...
readonly MANIFEST=$ROOT/deploy/failed-pre-mutation-abort-55d06e8f-replay2-schema2-manifest.json
readonly MANIFEST_SHA=beaee6b513f5ecef3ef8597ce27369ec8ec41fb29cb6a1f5e8512b97852394ab
readonly LAUNCHER=$ROOT/deploy/launch-failed-pre-mutation-abort-55d06e8f-replay2-schema2-formal.sh
readonly LAUNCHER_SHA=76ff701c1f956746b595a69d7171973059412f3d2fbd391a7af54c1ae96e1b0a
readonly GATE=$ROOT/deploy/gate-failed-pre-mutation-abort-55d06e8f-replay2-schema2-formal.py
readonly GATE_SHA=235c00f614e84c69312c2f12cdaebd435a4320f3645173ad5bfef69c4186bc15
readonly APPROVAL=/home/wilf/.local/state/viewflow/deployments/$OP/failed-pre-mutation-abort-replay2-schema2-execution-approval.json
readonly PRIOR_APPROVAL=/home/wilf/.local/state/viewflow/deployments/$OP/failed-pre-mutation-abort-schema2-execution-approval.json
readonly PRIOR_APPROVAL_SHA=f7269f591e96bb518dde595c7d1b8e425d8e2155aec4ba1d32164f4299abcba4
...
jq -e --arg op "$OP" --arg coordinator 0926c2f0b87acdd58617a33efefd235ed1ba33195eeae0f42cefc26715f34e75 \
    --arg marker e791a290aa112a1484bdfcce1de439a82e181ee5c1b3621f3b142d68e4e40b66 '
    keys == ["active_marker_gate","adopted_outputs","approval","argv","execution_authorized","fresh_outputs","immutable_terminal_inputs","installed_v13_inputs","marker_candidate","operation_id","prior_approval","required_absent","reviewed_code","schema_version","state","threat_boundary"] and
    .schema_version == 2 and .state == "viewflow-failed-pre-mutation-abort-replay2-schema2-command-manifest" and
    ...
    .prior_approval == {path:"/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-schema2-execution-approval.json",sha256:"f7269f591e96bb518dde595c7d1b8e425d8e2155aec4ba1d32164f4299abcba4",mode:600} and
