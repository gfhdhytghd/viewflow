...
readonly MANIFEST=$ROOT/deploy/failed-pre-mutation-abort-55d06e8f-replay3-schema2-manifest.json
readonly MANIFEST_SHA=639b6b32b6e3a70fda5d9cb77e9cef447f7a94370d9a5168534c8ab13170e7be
readonly LAUNCHER=$ROOT/deploy/launch-failed-pre-mutation-abort-55d06e8f-replay3-schema2-formal.sh
readonly LAUNCHER_SHA=a4f7dde02e10f0101c15537108ba2ed214ba58bc0f5f240c5335e0b8e58d481f
readonly GATE=$ROOT/deploy/gate-failed-pre-mutation-abort-55d06e8f-replay3-schema2-formal.py
readonly GATE_SHA=154b89c8319d29b72affba0e4842becf3b19f6328312570fd69d8e582fce1fe8
readonly APPROVAL=/home/wilf/.local/state/viewflow/deployments/$OP/failed-pre-mutation-abort-replay3-schema2-execution-approval.json
...
jq -e --arg op "$OP" --arg coordinator df7ca6250e15f13b5f24e2f9bb162b21f00f1a58c0dd01d27325df76de3a5518 \
    --arg marker e791a290aa112a1484bdfcce1de439a82e181ee5c1b3621f3b142d68e4e40b66 '
    keys == ["active_marker_gate","adopted_outputs","approval","argv","execution_authorized","fresh_outputs","immutable_terminal_inputs","initial_approval","installed_v13_inputs","marker_candidate","operation_id","prior_approval","required_absent","reviewed_code","schema_version","state","threat_boundary"] and
    .schema_version == 2 and .state == "viewflow-failed-pre-mutation-abort-replay3-schema2-command-manifest" and
