...
checker=$root/deploy/check-failed-v21-rollback-abort-845ce422.sh
manifest=$root/deploy/failed-v21-rollback-abort-845ce422-manifest.json
gate=$root/deploy/failed-v21-rollback-abort-845ce422-gate.py
...
"$checker"
echo '845ce422 abort static negative mutations passed'
