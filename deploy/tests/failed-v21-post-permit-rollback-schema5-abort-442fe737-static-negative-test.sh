...
hermetic=$root/deploy/tests/failed-v21-post-permit-rollback-schema5-abort-442fe737-hermetic.py
checker=$root/deploy/check-failed-v21-post-permit-rollback-schema5-abort-442fe737.sh
temporary=$(mktemp -d)
...
echo '442fe737 schema5 abort static-negative tests passed'
