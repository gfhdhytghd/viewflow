...
readonly MANIFEST=$ROOT/deploy/failed-pre-mutation-abort-55d06e8f-replay5-schema2-manifest.json
readonly MANIFEST_SHA=9a0cb489a973c1d4d19c2c5a168d4ea3942a679c6fe329f99d35f6a9ccabf43a
readonly LAUNCHER=$ROOT/deploy/launch-failed-pre-mutation-abort-55d06e8f-replay5-schema2-formal.sh
readonly LAUNCHER_SHA=63c57effdab8da0bcd5193f484c53bfae4b0c433358ab1aab5102a4a97305c5b
readonly GATE=$ROOT/deploy/gate-failed-pre-mutation-abort-55d06e8f-replay5-schema2-formal.py
readonly GATE_SHA=430e7c2286b1b633fb657a226c80f11069b32d64f2526b91d8394f0c08785423
readonly APPROVAL=/home/wilf/.local/state/viewflow/deployments/$OP/failed-pre-mutation-abort-replay5-schema2-execution-approval.json
...
jq -e --arg op "$OP" --arg coordinator 455c3741cb3147b130dbe8d5246abebe94434f40a655119c302fbf6f5df27688 \
    --arg marker e791a290aa112a1484bdfcce1de439a82e181ee5c1b3621f3b142d68e4e40b66 '
    keys == ["active_marker_gate","adopted_outputs","approval","argv","execution_authorized","fresh_outputs","immutable_terminal_inputs","initial_approval","installed_v13_inputs","marker_candidate","operation_id","prior_approval","required_absent","reviewed_code","schema_version","state","superseded_replay3","superseded_replay4","threat_boundary"] and
    .schema_version == 2 and .state == "viewflow-failed-pre-mutation-abort-replay5-schema2-command-manifest" and
