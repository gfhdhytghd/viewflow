...
approval_spec = importlib.util.spec_from_file_location(
    "vf_v4_approval",
    "/home/wilf/data/viewflow/deploy/publish-failed-pre-mutation-abort-83fa3121-no-retry-approval.py",
)
approval = importlib.util.module_from_spec(approval_spec)
approval_spec.loader.exec_module(approval)

manifest = json.loads(Path(
    "/home/wilf/data/viewflow/deploy/failed-pre-mutation-abort-83fa3121-no-retry-manifest.json"
).read_text())
