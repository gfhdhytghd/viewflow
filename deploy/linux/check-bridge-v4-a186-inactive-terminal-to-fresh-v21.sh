...
target=${1:-$(cd -- "$(dirname -- "$0")" && pwd)/bridge-v4-a186-inactive-terminal-to-fresh-v21.sh}
...
for token,label in (
 ...
 ('readonly V4_OPERATION=a18635e6e23f4304afaca816333f3455','frozen V4 operation'),
 ('readonly V4_MARKER_CLI_SHA=c237736c4d8d4db6ba6e118ac46dc083bdf3d8ae99a0b08716bc5d3206fc6c57','frozen V4 CLI'),
 ('readonly V4_PROVENANCE_SHA=86c91f2f97e26b2f5c9f81207700c76207430e696a16a911389dc498e2dbe454','frozen V4 provenance'),
 ('readonly V4_MANIFEST_SHA=d628b3169232947a702d8ba95b6343985d02a8c05c7a450965d4086379e19c49','frozen V4 manifest'),
 ('readonly V4_GATE_SHA=f8eee3443adfeb1adca67a96dd03ba835e6fd1e3d0758536c1724cb2659acae3','frozen V4 gate'),
 ('readonly V4_LAUNCHER_SHA=ba3d055108e983b3eac66ad0701551c7e01bed96d8d2e030db76133d8650ef35','frozen V4 launcher'),
...
for token in ('terminal_keys=', 'approval_keys=', 'auth_keys=', 'receipt_keys=', "type(t['input_producer_count']) is int",
              ...
              "p['candidate']['mode']=='0700'", 'validate_vfdqa', 'import calendar,json,re,sys,time',
