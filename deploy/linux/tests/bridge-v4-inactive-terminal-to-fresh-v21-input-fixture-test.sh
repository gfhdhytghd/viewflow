...
approval=$deployment/failed-pre-mutation-abort-83fa3121-no-retry-execution-approval.json
...
manifest='8a13bf6f5df4fb6cc6fb36e4a0d7a6be65d787a358a0259d360862e8ac62cf11'
gate='e2c0f4a2968bfb9f23fe224d1f9ec815c22ce1bb953151a55c4d44c166087a29'
launcher='a23dba7212fab71b50d9d4508d2ee1e834af87495a65bcae059b0a4208fcd9d1'
...
durable[272:304]=bytes.fromhex(marker_sha);durable[304:336]=bytes.fromhex(auth_sha);durable[336:344]=(2000).to_bytes(8,'little')
...
receipt.update({'abort_authorization_path':auth_path,'abort_authorization_sha256':auth_sha,
 'abort_claim_path':'/home/wilf/.local/state/viewflow/deployment-quarantine.v1.abort-claim','abort_committed_at_unix_ms':'2000',
 'abort_committed_at_utc':'1970-01-01T00:00:02.000Z','abort_point':'abort-claim-unlink-and-parent-directory-fsync',
...
text=text.replace('readonly V4_PROVENANCE_SHA=f3023dd53acade01874af56a22fda0be126fd3bdb8160d9a471cc17cd320b7bd','readonly V4_PROVENANCE_SHA='+provenance_sha)
