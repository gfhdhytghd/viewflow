...
launcher=/home/wilf/data/viewflow/deploy/launch-failed-pre-mutation-abort-a18635e6-no-retry.sh
...
MANIFEST = "/home/wilf/data/viewflow/deploy/failed-pre-mutation-abort-a18635e6-no-retry-manifest.json"
