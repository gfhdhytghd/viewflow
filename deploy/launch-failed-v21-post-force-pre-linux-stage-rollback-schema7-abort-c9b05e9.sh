...
launcher=/home/wilf/data/viewflow/deploy/launch-failed-v21-post-force-pre-linux-stage-rollback-schema7-abort-c9b05e9.sh
...
GATE = "/home/wilf/data/viewflow/deploy/failed-v21-post-force-pre-linux-stage-rollback-schema7-abort-c9b05e9-gate.py"
...
gate_fd = seal("viewflow-schema7-abort-gate-c9b05e9", gate, 0o700)
manifest_fd = seal("viewflow-schema7-abort-manifest-c9b05e9", manifest, 0o600)
launcher_fd = seal("viewflow-schema7-abort-launcher-c9b05e9", launcher_raw, 0o700)
