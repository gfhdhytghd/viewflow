...
launcher=/home/wilf/data/viewflow/deploy/launch-failed-pre-mutation-abort-305058f7-no-retry-successor1.sh
...
MANIFEST = "/home/wilf/data/viewflow/deploy/failed-pre-mutation-abort-305058f7-no-retry-successor1-manifest.json"
...
gate_fd = seal("viewflow-v4-gate-305", gate, 0o700)
manifest_fd = seal("viewflow-v4-manifest-305", manifest, 0o600)
launcher_fd = seal("viewflow-v4-launcher-305", launcher, 0o700)
