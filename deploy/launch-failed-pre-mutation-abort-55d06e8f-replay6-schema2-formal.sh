...
readonly MANIFEST=/home/wilf/data/viewflow/deploy/failed-pre-mutation-abort-55d06e8f-replay6-schema2-manifest.json
readonly MANIFEST_SHA256=38764b640df1e304068ff33adc54939986a9b41181edfdcbaabb4a78a000ed3f
readonly APPROVAL=/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-replay6-schema2-execution-approval.json
...
expected_manifest_keys={"active_marker_gate","adopted_outputs","approval","argv","execution_authorized","fresh_outputs","immutable_terminal_inputs","initial_approval","installed_v13_inputs","marker_candidate","operation_id","prior_approval","replay2_approval","required_absent","reviewed_code","schema_version","state","superseded_replay3","superseded_replay4","superseded_replay5","threat_boundary"}
if not (set(manifest)==expected_manifest_keys and manifest.get("schema_version")==2 and manifest.get("state")=="viewflow-failed-pre-mutation-abort-replay6-schema2-command-manifest" and manifest.get("execution_authorized") is False and manifest.get("operation_id")==op and manifest.get("threat_boundary")=="cooperating-crash-and-non-owner"):
    raise SystemExit(67)
...
replay2=manifest["replay2_approval"]
initial=manifest["initial_approval"]
expected_prior={"path":"/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-replay5-schema2-execution-approval.json","sha256":"e2e20b047c301db5374eed3e34c0c61aa45bc440b588eee5f3ee361d75a0a1bf","mode":600}
expected_replay2={"path":"/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-replay2-schema2-execution-approval.json","sha256":"c96a4507416767b5f2f1a3631fb79094629e6c4f44ef39aaa567cf2902db7cab","mode":600}
...
if prior!=expected_prior or replay2!=expected_replay2 or initial!=expected_initial:
    raise SystemExit(67)
...
if superseded!=expected_superseded:
    raise SystemExit(67)
superseded4=manifest["superseded_replay4"]
superseded4_outputs=[
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/pre-mutation-windows-live.replay4.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/windows-v13-started.replay4.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/authenticated-v13-peer.replay4.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-authorization.replay4.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-receipt.replay4.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-terminal.replay4.schema2.json",
]
expected_superseded4={"state":"viewflow-failed-pre-mutation-abort-replay4-never-approved","approval_path":"/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-replay4-schema2-execution-approval.json","approval_required_absent":True,"fresh_outputs":superseded4_outputs,"fresh_outputs_required_absent":True,"frozen_chain":{"manifest_sha256":"0b93a56956528b618eff14e09e28ae6cef15a8a9e9b3403ac6c8049962c6904b","launcher_sha256":"af054335e059f75329f9c656d4abd4c427879566baab1b4a10bc583cb518d64b","gate_sha256":"c0dc4d97d63cd3f389bd2ef05da032e268480f49a51b67bd9b5beaca21386858","offline_fixture_sha256":"51e324aac3755f4ab56ab977784b9f7a0c6e441528fff25ef946e543db0fd1a6"}}
if superseded4!=expected_superseded4:
    raise SystemExit(67)
superseded5=manifest["superseded_replay5"]
superseded5_outputs=[
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/pre-mutation-windows-live.replay5.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/windows-v13-started.replay5.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/authenticated-v13-peer.replay5.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-authorization.replay5.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-receipt.replay5.schema2.json",
    "/home/wilf/.local/state/viewflow/deployments/55d06e8f96aa4adc9010e53612979374/failed-pre-mutation-abort-terminal.replay5.schema2.json",
]
expected_superseded5={"state":"viewflow-failed-pre-mutation-abort-replay5-approved-no-fresh-output","approval":expected_prior,"fresh_outputs":superseded5_outputs,"fresh_outputs_required_absent":True,"frozen_chain":{"manifest_sha256":"9a0cb489a973c1d4d19c2c5a168d4ea3942a679c6fe329f99d35f6a9ccabf43a","launcher_sha256":"63c57effdab8da0bcd5193f484c53bfae4b0c433358ab1aab5102a4a97305c5b","gate_sha256":"430e7c2286b1b633fb657a226c80f11069b32d64f2526b91d8394f0c08785423","offline_fixture_sha256":"89258acc54f8e1394b9dc81a4c41c97a9c13b4757eced0eb39f6bff4757b90c6"}}
if superseded5!=expected_superseded5:
    raise SystemExit(67)
...
if set(adopted)!={"linux_started"} or adopted["linux_started"]!={"path":expected_adopted_path,"sha256":"506281bd59fe982d9d8bdb7e6da6d4322b9b6aff9dfe61f2cbf0804abe728a9f","mode":600,"live_tuple":expected_live_tuple}:
    raise SystemExit(67)
entries=[]
for item in [*reviewed.values(),candidate,*terminal,*installed,prior,replay2,initial,{key:value for key,value in adopted["linux_started"].items() if key!="live_tuple"}]:
...
if set(initial_approval)!=initial_keys or any(initial_approval.get(key)!=value for key,value in expected_initial_approval.items()) or re.fullmatch(r"[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{3}Z",initial_approval.get("approved_at_utc","")) is None:
    raise SystemExit(67)
replay2_approval=json.loads(sealed[replay2["path"]][3].decode("utf-8"),object_pairs_hook=strict_pairs)
replay2_keys={"approved","approved_at_utc","coordinator_sha256","gate_sha256","launcher_sha256","manifest_sha256","marker_candidate_sha256","operation_id","prior_approval_sha256","publication_method","schema_version","state","terminal_state_sha256"}
expected_replay2_approval={"schema_version":2,"state":"viewflow-failed-pre-mutation-abort-replay2-schema2-execution-approved","approved":True,"operation_id":op,"manifest_sha256":"beaee6b513f5ecef3ef8597ce27369ec8ec41fb29cb6a1f5e8512b97852394ab","launcher_sha256":"76ff701c1f956746b595a69d7171973059412f3d2fbd391a7af54c1ae96e1b0a","gate_sha256":"235c00f614e84c69312c2f12cdaebd435a4320f3645173ad5bfef69c4186bc15","coordinator_sha256":"0926c2f0b87acdd58617a33efefd235ed1ba33195eeae0f42cefc26715f34e75","marker_candidate_sha256":candidate["sha256"],"terminal_state_sha256":"553b49cbc0f63b5586c959e9e2e0a7e53c9a44672b7e555cb5f3602a3dc6972f","prior_approval_sha256":initial["sha256"],"publication_method":"create-once-no-replace-and-parent-fsync"}
if set(replay2_approval)!=replay2_keys or any(replay2_approval.get(key)!=value for key,value in expected_replay2_approval.items()) or re.fullmatch(r"[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}\.[0-9]{3}Z",replay2_approval.get("approved_at_utc","")) is None:
    raise SystemExit(67)
prior_approval=json.loads(sealed[prior["path"]][3].decode("utf-8"),object_pairs_hook=strict_pairs)
prior_keys={"approved","approved_at_utc","coordinator_sha256","gate_sha256","initial_approval_sha256","launcher_sha256","manifest_sha256","marker_candidate_sha256","operation_id","prior_approval_sha256","publication_method","schema_version","state","terminal_state_sha256"}
expected_prior_approval={"schema_version":2,"state":"viewflow-failed-pre-mutation-abort-replay5-schema2-execution-approved","approved":True,"operation_id":op,"manifest_sha256":"9a0cb489a973c1d4d19c2c5a168d4ea3942a679c6fe329f99d35f6a9ccabf43a","launcher_sha256":"63c57effdab8da0bcd5193f484c53bfae4b0c433358ab1aab5102a4a97305c5b","gate_sha256":"430e7c2286b1b633fb657a226c80f11069b32d64f2526b91d8394f0c08785423","coordinator_sha256":"455c3741cb3147b130dbe8d5246abebe94434f40a655119c302fbf6f5df27688","marker_candidate_sha256":candidate["sha256"],"terminal_state_sha256":"553b49cbc0f63b5586c959e9e2e0a7e53c9a44672b7e555cb5f3602a3dc6972f","prior_approval_sha256":replay2["sha256"],"initial_approval_sha256":initial["sha256"],"publication_method":"create-once-no-replace-and-parent-fsync"}
...
if set(outputs)!=expected_output_keys or len(set(outputs.values()))!=6 or any(not isinstance(path,str) or not path.startswith("/home/wilf/.local/state/viewflow/deployments/"+op+"/") or ".replay6." not in path for path in outputs.values()):
    raise SystemExit(67)
...
def validate_absent(include_approval):
    absent=[*required_absent,*outputs.values(),superseded["approval_path"],*superseded_outputs,superseded4["approval_path"],*superseded4_outputs,*superseded5_outputs]
    if include_approval:
...
approval_keys={"approved","approved_at_utc","coordinator_sha256","gate_sha256","initial_approval_sha256","launcher_sha256","manifest_sha256","marker_candidate_sha256","operation_id","prior_approval_sha256","publication_method","replay2_approval_sha256","schema_version","state","terminal_state_sha256"}
expected={"schema_version":2,"state":"viewflow-failed-pre-mutation-abort-replay6-schema2-execution-approved","approved":True,"operation_id":op,"manifest_sha256":manifest_sha,"launcher_sha256":launcher_sha,"gate_sha256":gate_sha,"coordinator_sha256":reviewed["coordinator"]["sha256"],"marker_candidate_sha256":candidate["sha256"],"terminal_state_sha256":"553b49cbc0f63b5586c959e9e2e0a7e53c9a44672b7e555cb5f3602a3dc6972f","prior_approval_sha256":prior["sha256"],"replay2_approval_sha256":replay2["sha256"],"initial_approval_sha256":initial["sha256"],"publication_method":"create-once-no-replace-and-parent-fsync"}
