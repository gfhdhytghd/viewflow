#!/usr/bin/env python3
"""Static freeze checker for the operation-a186 no-retry V4 abort."""
...
def fail(message):
    raise SystemExit("a186 V4 checker: " + message)
...
def main():
    ...
    parser.add_argument("--gate", default="deploy/gate-failed-pre-mutation-abort-a18635e6-no-retry.py")
    parser.add_argument("--manifest", default="deploy/failed-pre-mutation-abort-a18635e6-no-retry-manifest.json")
    parser.add_argument("--launcher", default="deploy/launch-failed-pre-mutation-abort-a18635e6-no-retry.sh")
    ...
    print("a186 no-retry V4 static freeze checker passed")
