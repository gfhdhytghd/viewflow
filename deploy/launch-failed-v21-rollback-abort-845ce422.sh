...
launcher=/home/wilf/data/viewflow/deploy/launch-failed-v21-rollback-abort-845ce422.sh
...
GATE = "/home/wilf/data/viewflow/deploy/failed-v21-rollback-abort-845ce422-gate.py"
MANIFEST = "/home/wilf/data/viewflow/deploy/failed-v21-rollback-abort-845ce422-manifest.json"
GATE_SHA = "a347cbefa4a7617c885f7dfacee8918b9f40cf7b2e30379359e968bb59da2da8"
...
launcher_raw = stable_read(launcher_path, hashlib.sha256(open(launcher_path, "rb").read()).hexdigest(), 0o700)
gate_fd = seal("viewflow-abort-gate-845ce422", gate, 0o700)
manifest_fd = seal("viewflow-abort-manifest-845ce422", manifest, 0o600)
launcher_fd = seal("viewflow-abort-launcher-845ce422", launcher_raw, 0o700)
argv = ["/usr/bin/python3", "-I", f"/proc/self/fd/{gate_fd}",
        "--manifest", f"/proc/self/fd/{manifest_fd}", "--manifest-sha256", MANIFEST_SHA,
        "--gate-sha256", GATE_SHA, "--launcher-sha256", hashlib.sha256(launcher_raw).hexdigest(),
